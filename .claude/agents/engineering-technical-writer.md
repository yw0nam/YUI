...
## Scope
- `docs/` — `reference/backend-contract.md`, `reference/motions.md`, `reference/logging.md`, `reference/tts-emotion/`.
...
- `docs/reference/backend-contract.md` describes the `generate_express` cue contract for the backend agent; keep it aligned with `src/contract/types.ts` and the streaming parse in `src/io/chat-client.ts` (coordinate with the Software Architect).
- `docs/reference/motions.md` mirrors `configs/motions.json` (every motion id with description, playback policy, source clip).
