...
- **Contract source of truth** — `src/contract/types.ts` is the contract; consumers compile against it. `configs/motions.json` ↔ `docs/reference/motions.md` stay in lockstep.
