...
//!
//! The `onScaleChanged` JS listener (see `src/io/window/drag.ts`) is the seam for reacting to DPI changes
//! (e.g., snapping or re-centering).
//!
//! # Dispatcher seam
//! Click/pet-gesture events on the character region belong to the dispatcher. `src/io/window/drag.ts` emits
