...
const en: Record<string, string> = {
  ...
  "input.error_stalled": "Backend stopped responding · timed out after 45s",
  ...
  "devtools.inspector.off": "OFF",
  "devtools.inspector.baseline_only": "baseline only",
  "devtools.signal.active_app": "app",
  "devtools.signal.active_window_title": "title",
  "devtools.signal.posture": "posture",
  "devtools.signal.recent_apps": "recent apps",
  "devtools.signal.screenshot": "screenshot",
  "devtools.advanced.context_signals": "Context signals",
  "devtools.advanced.recent_apps_label": "Recent apps",
  "devtools.advanced.recent_apps_sub": "Include buffered foreground app changes",
  "devtools.advanced.active_app_label": "Active app",
  "devtools.advanced.active_app_sub": "Include the current foreground application",
  "devtools.advanced.window_title_label": "Window title",
  "devtools.advanced.window_title_sub": "Include the active window title",
  "devtools.advanced.posture_label": "Posture",
  "devtools.advanced.posture_sub": "Include the character's current posture",
  "devtools.advanced.limits": "Limits",
  "devtools.advanced.recent_apps_cap_label": "Recent apps cap",
  "devtools.advanced.recent_apps_cap_sub": "Maximum buffered app switches",
