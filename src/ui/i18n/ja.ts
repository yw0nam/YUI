...
const ja: Record<string, string> = {
  ...
  "devtools.inspector.off": "オフ",
  "devtools.inspector.baseline_only": "ベースラインのみ",
  "devtools.signal.active_app": "アプリ",
  "devtools.signal.active_window_title": "タイトル",
  "devtools.signal.posture": "姿勢",
  "devtools.signal.recent_apps": "最近のアプリ",
  "devtools.signal.screenshot": "スクリーンショット",
  "devtools.advanced.context_signals": "コンテキスト信号",
  "devtools.advanced.recent_apps_label": "最近のアプリ",
  "devtools.advanced.recent_apps_sub": "フォアグラウンドアプリの変更履歴を含める",
  "devtools.advanced.active_app_label": "アクティブなアプリ",
  "devtools.advanced.active_app_sub": "現在のフォアグラウンドアプリを含める",
  "devtools.advanced.window_title_label": "ウィンドウタイトル",
  "devtools.advanced.window_title_sub": "アクティブなウィンドウタイトルを含める",
  "devtools.advanced.posture_label": "姿勢",
  "devtools.advanced.posture_sub": "キャラクターの現在の姿勢を含める",
  "devtools.advanced.limits": "上限",
  "devtools.advanced.recent_apps_cap_label": "最近のアプリ数の上限",
  "devtools.advanced.recent_apps_cap_sub": "保持するアプリ切り替え履歴の最大数",
