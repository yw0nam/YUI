/**
 * Tests for src/io/window/cursor-tracker.ts — global OS-cursor tracker feeding cursor-gaze.
 *
 * Environment: node (vitest default) — fake window/scheduler/doc seams, no Tauri runtime
 * for the poll path (mirrors src/io/window/hit-test.test.ts's style).
 */
