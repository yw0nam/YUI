/**
 * Tests for src/io/window/pet/cursor-tracker.ts — global OS-cursor tracker feeding cursor-gaze.
 *
 * Environment: node (vitest default) — fake window/scheduler/doc seams, no Tauri runtime
 * for the poll path (mirrors src/io/window/pet/hit-test.test.ts's style).
 */
