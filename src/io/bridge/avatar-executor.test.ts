...
import type {
  ...
  PlacementRequest,
  PlacementResult,
} from "../window/window-drop-source";
...
/** Both monitors keep a 40px menu bar out of the work area. */
const MONITORS = [
  {
    position: { x: 0, y: 0 },
...
/** Canvas-local logical y of the feet anchor — the window bottom hangs 100px below it. */
const FEET_OFFSET_PX = 200;
