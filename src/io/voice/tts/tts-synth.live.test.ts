/**
 * Integration test against the real TTS service (:8088) — runs only when `YUI_LIVE=1`.
 *   YUI_LIVE=1 pnpm exec vitest run src/io/voice/tts/tts-synth.live.test.ts
 */
...
/** A voice the live server lists (GET /v1/audio/voices). */
const VOICE = "ナツメ";
