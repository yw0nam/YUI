...
YUI/
  ...
  src-tauri/
    ...
    src/                    # Rust: lib.rs, main.rs, drag.rs, screenshot.rs, agent_ingress.rs, import_fs.rs, log_rotation.rs, witness.rs, passthrough.rs, tray.rs, voice_import.rs, vrm_import.rs, os_event_watcher/ (mod·macos·windows)
