...
| `warn` | Recovered or degraded: a fallback was taken, malformed input dropped, an optional path skipped | `mouth_expression_missing`, broker unreachable (one warn per outage) |
