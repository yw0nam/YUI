...
| `peek` | state | yes (LoopRepeat; wrap is hidden behind the occluding window) | Held while side-perched; the clip walks out of view behind the app window. `broker_publish: false`. | PET_HIDING/PET_HIDE | 14.0s |
